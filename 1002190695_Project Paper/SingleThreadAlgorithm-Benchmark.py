# Implementation of Single thread Algorithm Runtime Analysis and Benchmarks

import numpy as np
import timeit
import matplotlib.pyplot as plt

class SortingAlgorithmsSingleThread:
